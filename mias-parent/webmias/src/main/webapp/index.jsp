                    ...
                    <div id="options" align="right">
                        <div class="search-option">
                            ...
                            <div class="search-option">
                                ...
                                <div>
                                    Extract subformulae:
                                    <!-- FIXME force extraction of subformulae -->
                                    <input type="checkbox" id="extractSubformulae" name="extractSubformulae" value="true" readonly="readonly" onclick="return false" checked="checked" />
                                </div>
                                <div>
                                    Reduce weights of derived formulae:
                                    <!-- FIXME force unreduced weighting -->
                                    <input type="checkbox" id="reduceWeighting" name="reduceWeighting" value="true" readonly="readonly" onclick="return false" />
                                </div>
                            </div>
                        </div>
